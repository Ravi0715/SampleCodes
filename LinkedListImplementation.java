...
public class LinkedListImplementation {
	...
	public static void main(String[] args) throws Exception{
		...
		String line;
		LinkedList<EmployeeModelClass> lemc =new LinkedList<EmployeeModelClass>();
		while((line=br.readLine())!=null)
		{
			...
			if(emc.getDesg().equals("asocprof"))
				lemc.addFirst(emc);//lemc.offerFirst(emc);
			else if(emc.getDesg().equals("astprof"))
				lemc.addLast(emc);//lemc.offerLast(emc);
			else
				lemc.offer(emc);
		}
		Iterator<EmployeeModelClass> iemc = lemc.iterator();
		while(iemc.hasNext())
		{
