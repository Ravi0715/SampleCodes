...
public class SetImplementation {
	...
	public static void main(String[] args) throws Exception{
		...
		String line;
		Set<EmployeeModelClass> semc = new HashSet<EmployeeModelClass>();
		...
		while(iemc.hasNext())
		{
			...
			double sal = em.getSalary().getBasic()+em.getSalary().getDa()+em.getSalary().getHra();
			if(sal>100000)
			{
				System.out.println(em.geteId()+" "+em.geteName()+" "+em.getDept()+" "+em.getDesg()+" "+sal+" "+em.getGradePoint());
			}
		}
		br.close();
		fr.close();
